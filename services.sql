...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Jun 2023 pada 20.39
...
--
-- Dumping data untuk tabel `chirps`
--

INSERT INTO `chirps` (`id`, `user_id`, `message`, `created_at`, `updated_at`) VALUES
(1, 1, 'Halo! aku sincan, apa kabar?', '2023-06-16 05:05:14', '2023-06-16 05:05:44');
...
(5, '2022_09_21_165520_create_chirps_table', 1);
...
(1, 'Sincan Maulana', 'me@sincan.dev', NULL, '$2y$10$bMdzQuHcLXTWf31cPkyEZ.qtvxQ7XTprdxpWAvruXS46Gxg5ZW3nu', NULL, '2023-06-16 05:05:01', '2023-06-16 05:05:01'),
(2, 'danang setyo wibowo', 'danang2002.dw@gamil.com', NULL, '$2y$10$W/MUF168tk0KNZsYUKgYx.JaGrKCmDoYLH/qHwyM0YtQ76i9QJ86m', NULL, '2023-06-16 05:37:25', '2023-06-16 05:37:25');
...
--
-- AUTO_INCREMENT untuk tabel `chirps`
--
ALTER TABLE `chirps`
...
--
-- Ketidakleluasaan untuk tabel `chirps`
--
ALTER TABLE `chirps`
...
('root', '[{\"db\":\"services\",\"table\":\"formulir\"},{\"db\":\"laravel\",\"table\":\"chirps\"}]');
...
('root', '2023-06-19 18:24:28', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"id\"}');
